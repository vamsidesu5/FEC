...
<tr>
   ...
   <td> <INPUT TYPE="button" value="Edit Employee Details" name="editEmployee" onclick="gotoEditEmployee(<c:out value='${row.EmployeeID}'/>)"></td>
   <td> <INPUT TYPE="button" value="Create Weekly Work Schedule" name="schedule" onclick="gotoSchedule(<c:out value='${row.EmployeeID}'/>)"></td>
</tr>
</c:forEach>
</table>
</form>
